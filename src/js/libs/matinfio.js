...
var custom_atom_loop_props = {'_atom_site_occupancy': 'site occupancies', '_atom_site_charge': 'formal charges'};
...
custom_atom_loop_props['label'] = 'labels';
...
function jsobj2player(crystal){
    ...
    if (!crystal.atoms.length) logger.warning("Note: no atomic coordinates");
