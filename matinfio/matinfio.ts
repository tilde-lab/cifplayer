	...
	export class $optimade_cifplayer_matinfio extends $mol_object2 {
		...
		internal_obj(): $optimade_cifplayer_matinfio_internal_obj {
			switch( this.source.format ) {
				...
				case 'POSCAR': return this.$.$optimade_cifplayer_matinfio_poscar_to_obj( this.source.data ) as any
				case 'OPTIMADE': return this.$.$optimade_cifplayer_matinfio_optimade_to_obj( this.source.data ) as any
				case 'OPTIMADE_str': return this.$.$optimade_cifplayer_matinfio_optimade_str_to_obj( this.source.data ) as any
			}
